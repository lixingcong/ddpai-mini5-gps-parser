...
- PC端Chrome浏览器（Android端可用Firefox或者Yandex）安装允许跨站请求的CORS扩展。在扩展应用商店中搜索CORS，条目有很多，如[Allow CORS](https://mybrowseraddon.com/access-control-allow-origin.html)或者[CORS Everywhere](https://github.com/spenibus/cors-everywhere-firefox-addon)
